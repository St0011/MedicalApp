...
public class Dentist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Deselectbtn1 = findViewById(R.id.Deselectbtn1);
        Deselectbtn1 = findViewById(R.id.Deselectbtn1);
        Dentbook = findViewById(R.id.Dentbook);
        calendar = Calendar.getInstance();
        Deselectbtn1.setText(getFormattedDateTime(calendar));

        Deselectbtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDateTimePickerDialog();
            }
        });
        Dentbook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Dentist.this, "Booking successful!", Toast.LENGTH_SHORT).show();
